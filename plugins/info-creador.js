...
let biografia = await conn.fetchStatus('50248019799' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `🐉𝙉𝙚𝙤𝙏𝙤𝙠𝙮𝙤 𝘽𝙚𝙖𝙩𝙨🐲`, dev, correo, `🇬🇹 Guatemala`, `${global.yt}`, bio],
