...
┃⍣ *ꨄ︎ ⏳️ 𝘈𝘤𝘵𝘪𝘷𝘰:* ${uptime}
┃⍣ *ꨄ︎ ✅ 𝘉𝘰𝘵 𝘜𝘴𝘰 𝘗𝘶𝘣𝘭𝘪𝘤𝘰*
┃⍣ *ꨄ︎ 🦁 𝘖𝘸𝘯𝘦𝘳: 🐉𝙉𝙚𝙤𝙏𝙤𝙠𝙮𝙤 𝘽𝙚𝙖𝙩𝙨🐲*
┃⍣ *ꨄ︎ 🔗 𝘊𝘶𝘦𝘯𝘵𝘢𝘴 𝘖𝘧𝘤:* https://whatsapp.com/channel/0029Vaqe1Iv65yDAKBYr6z0A
╰✧ » ◇ « ✧ » ✦ « ✧ » ◇ « ✧`.trim();
        const doc = [
    "pdf",
    "zip",
...
const document = doc[Math.floor(Math.random() * doc.length)];
  const Message = {
    document: { url: `https://whatsapp.com/channel/0029Vaqe1Iv65yDAKBYr6z0A` },
    mimetype: `application/${document}`,
    fileName: `「 BrolyBot-MD𝘵💥 」`,
